...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(68, 45);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"ＭＳ Ｐゴシック", 20.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(128)));
			this->button1->Location = System::Drawing::Point(68, 74);
			...
			this->radioButtonKisu->Font = (gcnew System::Drawing::Font(L"ＭＳ Ｐゴシック", 9, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(128)));
			this->radioButtonKisu->Location = System::Drawing::Point(64, 144);
			...
			this->radioButtonKisu->Click += gcnew System::EventHandler(this, &MyForm::radioClick);
			// 
			// radioButtonGusu
			// 
			...
			this->radioButtonGusu->Font = (gcnew System::Drawing::Font(L"ＭＳ Ｐゴシック", 9, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(128)));
			this->radioButtonGusu->Location = System::Drawing::Point(130, 144);
			...
			this->radioButtonGusu->Click += gcnew System::EventHandler(this, &MyForm::radioClick);
			// 
			// pictureDice1
			// 
			this->pictureDice1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureDice1.Image")));
			this->pictureDice1->Location = System::Drawing::Point(301, 74);
			this->pictureDice1->Name = L"pictureDice1";
			this->pictureDice1->Size = System::Drawing::Size(34, 33);
			...
			this->pictureDice2->Location = System::Drawing::Point(301, 74);
			this->pictureDice2->Name = L"pictureDice2";
			this->pictureDice2->Size = System::Drawing::Size(34, 33);
			...
			this->pictureDice3->Location = System::Drawing::Point(301, 74);
			this->pictureDice3->Name = L"pictureDice3";
			this->pictureDice3->Size = System::Drawing::Size(34, 33);
			...
			this->pictureDice4->Location = System::Drawing::Point(301, 74);
			this->pictureDice4->Name = L"pictureDice4";
			this->pictureDice4->Size = System::Drawing::Size(34, 33);
			...
			this->pictureDice5->Location = System::Drawing::Point(301, 74);
			this->pictureDice5->Name = L"pictureDice5";
			this->pictureDice5->Size = System::Drawing::Size(34, 33);
			...
			this->pictureDice6->Location = System::Drawing::Point(301, 74);
			this->pictureDice6->Name = L"pictureDice6";
			this->pictureDice6->Size = System::Drawing::Size(34, 33);
			...
			this->labelResult->Location = System::Drawing::Point(207, 272);
			...
			this->pictureWin->Location = System::Drawing::Point(208, 118);
			...
			this->pictureLose->Location = System::Drawing::Point(209, 118);
			...
			this->listBox1->Location = System::Drawing::Point(64, 172);
			this->listBox1->Name = L"listBox1";
			this->listBox1->Size = System::Drawing::Size(250, 136);
			...
			this->ゲームGToolStripMenuItem->Size = System::Drawing::Size(63, 20);
			...
			this->その他OToolStripMenuItem->Size = System::Drawing::Size(64, 20);
			this->その他OToolStripMenuItem->Text = L"その他(&O)";
			// 
			// EnvToolStripMenuItem
			// 
			this->EnvToolStripMenuItem->Name = L"EnvToolStripMenuItem";
			this->EnvToolStripMenuItem->Size = System::Drawing::Size(152, 22);
			...
			this->ScoreToolStripMenuItem->Size = System::Drawing::Size(152, 22);
			...
			this->ClientSize = System::Drawing::Size(442, 311);
...
private: System::Void ManageHistory(bool winGame) {
	...
	if (_historyCollection->Count>=5) {
		...
		//	i++;
		//}
		for each(int historyPoint in _historyCollection) {
				//合計得点を足しこみ
				sumPoint += historyPoint;
				//勝ち総数と負け総数の加算
				if (historyPoint==0) {
		...
		try {
			//スコア記録用のDice.datを開く
			//2017.08.20 あえて型とnewとを違えてみた↓
			System::IO::TextReader^ reader = gcnew System::IO::StreamReader("./Dice.dat");
			...
			//fファイルが存在しない場合、初期値0で新たなテキストファイルを作成
		...
		if(sumPoint>highScore){
			//2017.08.20 あえて型とnewとを違えてみた↓
			System::IO::TextWriter^ writer = gcnew System::IO::StreamWriter("./Dice.dat", false);
...
private: System::Void radioClick(System::Object^  sender, System::EventArgs^  e) {
	//各コントロールをゲーム終了の状態に変更
	ChangeControlStatus(false);
	//勝敗の判定
