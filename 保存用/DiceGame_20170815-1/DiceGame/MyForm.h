...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"ﾜﾀｼと勝負しよう！";
			// 
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"ＭＳ Ｐゴシック", 20, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
			...
			this->Font = (gcnew System::Drawing::Font(L"ＭＳ Ｐゴシック", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(128)));
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		if (this->rdbOdd->Checked) {
			...
			MessageBox::Show("奇数か偶数かを選んでください", "おねがい");
			return;
		}
		//サイコロの目をランダムに生成
		Random^ randomDice;
